...
> [!NOTE]  
> Keep using below `...yuzono/anime-repo...` URL, regardless where this actual GH repository is.

```html
https://raw.githubusercontent.com/yuzono/anime-repo/repo/index.min.json
```
just paste above URL into your anime repo

## Contributing

[Source code](https://github.com/yuzono/anime-extensions) and [Template](https://github.com/yuzono/anime-extensions/blob/master/CONTRIBUTING.md)

If you want to report issues, report them [here](https://github.com/yuzono/anime-extensions/issues/new/choose)
